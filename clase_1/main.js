...
// mensaje encriptado con array
mensaje.forEach(indice => {
  message = message + abecedario[indice]
});
console.log(message)

// Mensaje encriptado con map
let mapAbecedario = new Map();

for (let i = 0; i < abecedario.length; i++) {
    mapAbecedario.set(i, abecedario[i])
}


console.log(mapAbecedario)

mensaje.forEach(indice => {
  message = message + (mapAbecedario.get(indice))
  });
  console.log(message) 
